    ...
    <body>
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                //get and display content of category books
                $.ajax({
                    type: "GET",
                    url: "ListCategoryBooks?id=${param.id}&page=${param.page}",
                    dataType: "html",
                    error: function(error){
                        $("#content").hide().html("<b><span class='red'>An error occured: " +
            ...
            <div class="header">
                ...
                <div id="menu">
                    <ul>
                        ...
                        <li class="selected"><a href="category.jsp">books</a></li>
