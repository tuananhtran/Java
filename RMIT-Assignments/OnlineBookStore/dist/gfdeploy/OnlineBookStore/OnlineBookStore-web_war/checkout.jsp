...
<%-- in user not logged in, move to login page --%>
<c:if test="${empty user}">
    <script type="text/javascript">
        alert("Please login to check out!");
        window.location = "login.jsp?action=checkout";
    </script>
</c:if>
<%-- if cart session variable empty, initialize it and notify user --%>
<c:if test="${empty cart}">
    ...
    <script type="text/javascript">
        alert("Shopping cart is empty! Please add item(s) to your cart!");
    ...
    <body>
        <script type="text/javascript">
            ...
            function validate(){
                ...
                //if address is blank, display error
            ...
            <div class="center_content">
                <div class="left_content">
                    ...
                    <div class="feat_prod_box_details">
                        <p class="details">
                            Please provide shipping address and press confirm button to check out!
                            Otherwise, you can come back to add more items.
                        </p>

                        <div class="contact_form">
                            <div class="form_subtitle">check out shopping cart</div>
                            <form name="checkout" action="CheckOut" method="POST" onsubmit="return validate();">
                                <span class="red" style="display: none" id="addressError">Shipping address cannot be blank!</span>
                                <div class="form_row">
                ...
                <div class="right_content">
                    ...
                    <div class="cart">
                        ...
                        <div class="title"><span class="title_icon"><img src="images/cart.gif" alt="" title="" /></span>Check Out</div>
